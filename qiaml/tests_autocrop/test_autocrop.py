...
class Test_get_data_array(unittest.TestCase):
    ...
    def test_oneshot2(self):
        ...
        return
"""
The following unit testest only work locally with .tif files
that are downloaded from the shared google drive, the tif files
are too big to be uploaded to git hub
